CLASS zcx_abaplit_error DEFINITION
  PUBLIC
...
CLASS zcx_abaplit_error IMPLEMENTATION.
  METHOD constructor ##ADT_SUPPRESS_GENERATION.
    ...
    IF textid IS INITIAL.
      if_t100_message~t100key = zcx_abaplit_error.
    ELSE.
  ...
  METHOD raise.
    RAISE EXCEPTION NEW zcx_abaplit_error( message = val
                                          previous = previous ).
  ENDMETHOD.
ENDCLASS.
