class ZCX_ABAPLIT_AJSON_ERROR definition
  public
...
public section.
  ...
  constants:
    begin of ZCX_ABAPLIT_AJSON_ERROR,
    ...
    end of ZCX_ABAPLIT_AJSON_ERROR .
...
CLASS ZCX_ABAPLIT_AJSON_ERROR IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_ABAPLIT_AJSON_ERROR .
else.
...
method raise.
  ...
  data lx type ref to zcx_abaplit_ajson_error.
