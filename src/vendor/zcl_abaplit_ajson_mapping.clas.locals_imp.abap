class lcl_mapping_fields implementation. "DEPRECATED
  ...
  method zif_abaplit_ajson_mapping~to_abap.
  ...
  method zif_abaplit_ajson_mapping~to_json.
  ...
  method zif_abaplit_ajson_mapping~rename_node.
  ...
  method zif_abaplit_ajson_mapping~rename_node.
    ...
    case mv_rename_by.
      ...
      when zcl_abaplit_ajson_mapping=>rename_by-full_path.
        ...
        lv_pair_found = boolc( sy-subrc = 0 ).
      when zcl_abaplit_ajson_mapping=>rename_by-pattern.
        lv_full_path = is_node-path && cv_name.
...
class lcl_mapping_to_upper implementation.
  ...
  method constructor.
    ...
    mi_mapping_fields = zcl_abaplit_ajson_mapping=>create_field_mapping( it_mapping_fields ).
