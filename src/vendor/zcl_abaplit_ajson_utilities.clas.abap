class zcl_abaplit_ajson_utilities definition
  public
  create public.
  ...
  public section.
    ...
    class-methods new
      returning
        value(ro_instance) type ref to zcl_abaplit_ajson_utilities.
    methods diff
      importing
        !iv_json_a            type string optional
        !iv_json_b            type string optional
        !io_json_a            type ref to zif_abaplit_ajson optional
        !io_json_b            type ref to zif_abaplit_ajson optional
        !iv_keep_empty_arrays type abap_bool default abap_false
      exporting
        !eo_insert            type ref to zif_abaplit_ajson
        !eo_delete            type ref to zif_abaplit_ajson
        !eo_change            type ref to zif_abaplit_ajson
      raising
    ...
    methods merge
      importing
        ...
        !iv_keep_empty_arrays type abap_bool default abap_false
      returning
        value(ro_json)        type ref to zif_abaplit_ajson
      raising
        zcx_abaplit_ajson_error.
    methods sort
      importing
        !iv_json         type string optional
        !io_json         type ref to zif_abaplit_ajson optional
      returning
    ...
    methods is_equal
      importing
        !iv_json_a            type string optional
        !iv_json_b            type string optional
        !ii_json_a            type ref to zif_abaplit_ajson optional
        !ii_json_b            type ref to zif_abaplit_ajson optional
      returning
    ...
    class-methods iterate_array
      importing
        ii_json type ref to zif_abaplit_ajson
        iv_path type string
      returning
        value(ri_iterator) type ref to zif_abaplit_ajson_iterator
      raising
        zcx_abaplit_ajson_error.
  ...
  private section.
    ...
    data mo_json_a type ref to zif_abaplit_ajson.
    data mo_json_b type ref to zif_abaplit_ajson.
    data mo_insert type ref to zif_abaplit_ajson.
    data mo_delete type ref to zif_abaplit_ajson.
    data mo_change type ref to zif_abaplit_ajson.
...
CLASS ZCL_ABAPLIT_AJSON_UTILITIES IMPLEMENTATION.
    ...
    do.
      ...
      if iv_keep_empty_arrays = abap_false.
        loop at io_json->mt_json_tree into ls_json_tree
          where type = zif_abaplit_ajson_types=>node_type-array and children = 0. "#EC CI_SORTSEQ
      ...
      loop at io_json->mt_json_tree into ls_json_tree
        where type = zif_abaplit_ajson_types=>node_type-object and children = 0. "#EC CI_SORTSEQ
  ...
  method diff.
    ...
    mo_insert = zcl_abaplit_ajson=>create_empty( ).
    mo_delete = zcl_abaplit_ajson=>create_empty( ).
    mo_change = zcl_abaplit_ajson=>create_empty( ).
  ...
  method is_equal.
    ...
    data li_ins type ref to zif_abaplit_ajson.
    data li_del type ref to zif_abaplit_ajson.
    data li_mod type ref to zif_abaplit_ajson.
  ...
  method iterate_array.
    ...
    create object ri_iterator type lcl_node_iterator
      exporting
        iv_node_type = zif_abaplit_ajson_types=>node_type-array
        ii_json = ii_json
        iv_path = iv_path.
  ...
  method iterate_object.
    ...
    create object ri_iterator type lcl_node_iterator
      exporting
        iv_node_type = zif_abaplit_ajson_types=>node_type-object
        ii_json = ii_json
        iv_path = iv_path.
  ...
  method normalize_input.
    ...
    if boolc( iv_json is initial ) = boolc( io_json is initial ).
      zcx_abaplit_ajson_error=>raise( 'Either supply JSON string or instance, but not both' ).
    endif.

    if iv_json is not initial.
      ro_json = zcl_abaplit_ajson=>parse( iv_json ).
    elseif io_json is not initial.
      ro_json = io_json.
    else.
      zcx_abaplit_ajson_error=>raise( 'Supply either JSON string or instance' ).
    endif.
  ...
  method sort.
    ...
    data lo_json type ref to zif_abaplit_ajson.
