interface zif_abaplit_ajson_mapping
  public.
  ...
  types:
    ty_table_of type standard table of ref to zif_abaplit_ajson_mapping.
  ...
  methods rename_node
    ...
    changing
      !cv_name type zif_abaplit_ajson_types=>ty_node-name.
