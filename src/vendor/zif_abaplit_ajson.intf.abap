interface zif_abaplit_ajson
  ...
  data mt_json_tree type zif_abaplit_ajson_types=>ty_nodes_ts read-only.

  " CLONING

  methods clone
    returning
      value(ri_json) type ref to zif_abaplit_ajson
    raising
  ...
  methods get_node_type
    importing
      iv_path type string
    returning
      value(rv_node_type) type zif_abaplit_ajson_types=>ty_node_type.
  ...
  methods set
    importing
      ...
      iv_node_type type zif_abaplit_ajson_types=>ty_node_type optional
    returning
      value(ri_json) type ref to zif_abaplit_ajson
    raising
      zcx_abaplit_ajson_error.
