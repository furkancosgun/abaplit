CLASS z2fiori_cl_state_codec DEFINITION
  ...
  PRIVATE SECTION.
    TYPES tt_names TYPE STANDARD TABLE OF string WITH DEFAULT KEY.
...
CLASS z2fiori_cl_state_codec IMPLEMENTATION.
  METHOD hydrate.
    FIELD-SYMBOLS <ls_attr_val> TYPE any.
        ...
        DATA lt_names TYPE z2fiori_cl_state_codec=>tt_names.
  ...
  METHOD public_attribute_names.
    ...
    FIELD-SYMBOLS <ls_attr> LIKE LINE OF lo_desc->attributes.
